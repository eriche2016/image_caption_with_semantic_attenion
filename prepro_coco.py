...
def main(params):
    ...
    L, label_start_ix, label_end_ix, label_length, L_semantic = encode_captions(imgs, params, wtoi,\
                                model,functional_words,threshold_metric_name,output_metric_name,vocab,is_functional,pt)
...
if __name__ == "__main__":
    ...
    # input json
    parser.add_argument('--input_json', default='dataset/mscoco/coco_raw.json',  help='input json file to process into hdf5')
    ...
    parser.add_argument('--images_root', default='dataset/mscoco/images',
